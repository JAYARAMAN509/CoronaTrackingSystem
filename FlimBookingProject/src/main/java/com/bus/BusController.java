	...
	public String bookSeat(@ModelAttribute("Seat") Seat seat, @RequestParam("movieName") String movieName,
		...
		if (object == null) {
			...
			if (((date.isAfter(currentDate)) || (date.equals(currentDate)))
				...
				new BusController().sendEmail(list.get(0).getMovieName(),list.get(0).getSeat(),list.get(0).getCustomer().getEmail(),list.get(0).getCustomer().getName(),list.get(0).getBookOnDate(),list.get(0).getShowTime(),list.get(0).getPrice(),sum);
				
				System.out.println("=================Ending Mail=============");
				return "redirect:/home";
...
//	Order history
	...
	// Email Code
	public void sendEmail(String MovieName,List<String> Seats,String Email,String Name, Date date,String time,List<Double> price,double sum) {
		System.out.println(MovieName);
		String recipient = Email; 
	     ...
	     Session session = Session.getDefaultInstance(properties, new javax.mail.Authenticator() {
		      protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("j47555601@gmail.com","jbcvlasyoairkfvg");
		      }
		      });
		      ...
		      try
		      {
		         ...
		         message.addRecipient(Message.RecipientType.TO, new InternetAddress(recipient));
			      message.setSubject("Ticket Booked Welcome To JAY CINEMAS"); 
			     
			    message.setContent("<body><center><table border=1 style='border-left:5px solid red;border-radius:10px;background: rgb(34,193,195);background: linear-gradient(0deg, rgba(34,193,195,1) 0%, rgba(0,0,0,1) 100%);'>"
			    		+ "<tr><th><h2 style='color:red'>Movie Name  </h2></th><th style='color:red'><h3>"+MovieName+"</th></tr></h3>"
			    		+ "			<tr><th style='color:white;'> Seat No :</th><th style='color:white;'>"+Seats+"</th></tr>"
			    				+ "<tr><th style='color:white;'>Email :</th><th style='color:white;'>"+Email+"</th></tr>"
			    						+ "<tr><th style='color:white;'> Date :</th><th style='color:white;'>"+date+"</th></tr>"
			    						+"<tr><th style='color:white;'> Time :</th><th style='color:white;'> "+time+"</th></tr>"
			    								+ "<tr><th style='color:white;'>Ticket per price</th><th style='color:white;'>"+price+"</th></tr>"
			    										+ "<tr><th style='color:white;'> Total Amount</th><th style='color:white;'>"+sum+"</th></tr></h1></center></body>","text/html");
